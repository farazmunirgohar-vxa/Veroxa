...
- Branch `agent/momo-readiness-closeout` is a locally reviewed but unmerged feature candidate based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`. It has 203 Sites files at `fce38a41f6afc94d5999d3268baea3c72012a8205f1bf97008e3f04900db6b37` and 44 mirrored migrations at `7ea30e35ee2dd88fc936521d352ef1b5794b6bfea981afd7e1b9b5c8a22af16c`. No feature PR exists yet; merge, exact-head workflows, review threads, database apply, Sites publish, and activation are all unclaimed.
- The only pending source migration is provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql`, mirrored byte-for-byte at SHA-256 `3d6394b402247d599f80466855dc14326d48add91f359b70a5cd75a9058fd441`. Supabase MCP assigns the production ledger version. After applying those exact reviewed bytes, capture the generated version and immediately merge a terminal follow-up PR that renames both mirrors without changing SQL bytes and refreshes live/candidate/Sites fingerprints; never claim permanent `045812` live-version equality.
