## 2026-08-08 — Ready decisions + generic-food v2 reviewed candidate; DB/Sites cutover pending

- Current production is canonical GitHub `main` `59b1604d887547e2804bdd6d63c97292385dcebb` (merged PR #163), Sites v39 from checkout `8749a7d442d3bb068ce626a9d297b8b227493446` (201 files, `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292`), and 43 applied Supabase migrations at exact live-ledger tree `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c` through `20260808041629_repair_momo_client_v3_displayed_asset_scope.sql`. The historical v36 repository/Sites-mirror tree `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90` is not live-ledger evidence.
- Draft PR #164 is open from branch `agent/momo-generic-food-ready-review-v5`, based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`. Its observed opening head is `b659ec307da9455c389059b29f2d6f3ab51f095e` with Git tree `9931d63dcb16a2e2e1cb7c592d2da63b4054cb60`; this is a draft checkpoint, not final-head workflow/review evidence. The candidate remains 203 Sites files at `357f6b336993d2c306c102d5be2699d7145a3144041eeb9753a2a43c48fe869e` and 44 mirrored migrations at `9cc0bba007b6a0c06edf33563fb1bc3f4650811f8f8ea1639cc58c7028ac7324`. Merge, exact-final-head workflows, review threads, database apply, Sites publish, and activation are unclaimed.
- The only pending source migration is provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql`, mirrored byte-for-byte at SHA-256 `9cf6f0080d38d58d3c1939d928444701b1954bf5cfe96bf7f3e80077bad45cc0`. Supabase MCP assigns the production ledger version. After applying those exact reviewed bytes, capture the generated version and immediately merge a terminal follow-up PR that renames both mirrors without changing SQL bytes and refreshes live/candidate/Sites fingerprints; never claim permanent `045812` live-version equality.
- Zero-unsafe-window rollout is mandatory: merge the reviewed candidate → freeze all new content/package reservation plus verified-upload auto-advance/dispatch ingress → drain v4 nonterminal/webhook/outbox/unsettled-cost work to zero → apply exact SQL bytes through Supabase MCP → verify v5 and legacy-v4 boundaries → reconcile the generated migration version in GitHub → publish and verify the exact terminal Sites source → only then restore the prior bounded internal ingress. Live Sites v39 parses v4 while the new database reserves v5, so neither DB-first nor Sites-first deployment is safe without the freeze/drain gate.
- Scoped production database/Sites deployment permission exists and automatic deployments remain disabled. Provider connections, external/public writes, scheduling, posting, review replies, website writes, owner contact, and Momo activation remain false. `02609` also remains non-comprehensive because live `postgres` is not a `supabase_admin` member and that role was skipped.

## 2026-08-08 — historical pre-v39 corrective Sites checkpoint
