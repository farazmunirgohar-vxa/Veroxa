## 2026-08-08 — locked Ready decisions + generic-food v2 cutover boundary

- Current production is canonical GitHub main `59b1604d887547e2804bdd6d63c97292385dcebb` from merged PR #163, Sites v39 checkout `8749a7d442d3bb068ce626a9d297b8b227493446` with 201 files at `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292`, and exact live43 at `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c` through verified `041629`. Historical repository/Sites-mirror evidence remains `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90`.
- Draft PR #164 is open from `agent/momo-generic-food-ready-review-v5`, base main59b, at observed opening head `b659ec307da9455c389059b29f2d6f3ab51f095e` / tree `9931d63dcb16a2e2e1cb7c592d2da63b4054cb60`. This is not final-head workflow/review evidence. The candidate remains 203 Sites files at `a8d5b75ab251f3502b87ec2c99c5f3d51aa7381e0ccefbc94b6183bb92a4c1d0` plus 44 mirrored migrations at `9cc0bba007b6a0c06edf33563fb1bc3f4650811f8f8ea1639cc58c7028ac7324`. PR #164 is unmerged; do not describe any candidate behavior, DB44 migration, or v5 Sites caller as live.
- `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is the provisional pre-apply source name, mirrored at exact SHA-256 `9cf6f0080d38d58d3c1939d928444701b1954bf5cfe96bf7f3e80077bad45cc0`. Supabase MCP generates the live version. Preserve exact bytes, capture the generated version after apply, and immediately reconcile both mirror filenames and all fingerprints through a reviewed follow-up PR before publishing Sites.
- The compatibility lock is permanent: live Sites v39 understands v4, while the pending migration makes new reservations v5. A safe cutover must merge the reviewed candidate, freeze reservation/verified-upload auto-advance/dispatch ingress, drain all v4 and staged work to zero, apply and verify exact SQL bytes, reconcile the generated ledger version in GitHub, publish and verify the exact terminal Sites source, then restore only bounded internal ingress.
- Scoped database/Sites production permission does not authorize automation. Automatic deployments, provider connections, external/public writes, scheduling, posting, review replies, website writes, owner contact, and Momo activation remain false. Applied `02609` retains its non-comprehensive `supabase_admin` ACL residual.

## 2026-08-08 — historical live43 repair / corrective Sites boundary
