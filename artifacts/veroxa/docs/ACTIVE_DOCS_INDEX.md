...
- **Verified production:** canonical GitHub `main` is merged PR #163 at `59b1604d887547e2804bdd6d63c97292385dcebb`; Sites v39 is live from checkout `8749a7d442d3bb068ce626a9d297b8b227493446`, 201 files at `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292`. Production Supabase remains the exact 43-row ledger `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c` through verified `041629`. Historical v36 repository/Sites-mirror evidence `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90` is separate.
- **Reviewed candidate:** draft PR #164 is open from `agent/momo-generic-food-ready-review-v5`, based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`. Observed opening head `b659ec307da9455c389059b29f2d6f3ab51f095e` / Git tree `9931d63dcb16a2e2e1cb7c592d2da63b4054cb60` is not final-head workflow/review evidence. The current pre-apply fingerprint remains 203 Sites files at `a8d5b75ab251f3502b87ec2c99c5f3d51aa7381e0ccefbc94b6183bb92a4c1d0` and 44 mirrored migrations at `9cc0bba007b6a0c06edf33563fb1bc3f4650811f8f8ea1639cc58c7028ac7324`. PR #164 is unmerged; workflows/review threads are unrecorded, and database/Sites changes are unexecuted.
- **Pending database source:** provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is mirrored at SHA-256 `9cf6f0080d38d58d3c1939d928444701b1954bf5cfe96bf7f3e80077bad45cc0`. Supabase MCP generates the live version. After exact-byte apply, capture that version and immediately merge a follow-up PR renaming both mirrors without changing SQL bytes; refresh all live/candidate/Sites fingerprints before publication.
- **Mandatory rollout:** merge reviewed feature PR → freeze new reservations plus verified-upload auto-advance/dispatch → drain every v4 nonterminal/webhook/outbox/unsettled-cost path to zero → apply exact SQL bytes → verify DB44 behavior and legacy v4 boundaries → reconcile the generated migration version in GitHub → publish/verify the exact terminal Sites source → restore bounded internal ingress. DB-first and Sites-first are unsafe without this freeze/drain sequence.
- Scoped database/Sites deployment permission is recorded, but automatic deployment and all rollout steps remain incomplete. Provider connections, external/public writes, scheduling, posting, review replies, website writes, owner authority, and Momo activation remain false. `02609` retains the known non-comprehensive `supabase_admin` ACL residual.
