...
- **Live Sites / GitHub lineage:** Sites v37 is live from checkout `61e9ace7723ef56f42111f320327187596406944`, with 200 files at `929e05cf68a6af5176811f49321ec108e617b93a08153b65b3f86b109d0c8c18`. PR #162 is already merged as canonical GitHub `main` `ca47aeff7ab44a69b6ce039608ae27fea6c3c326` and the corrective-candidate base. This advances repository lineage only; it is not corrected-source/live-Sites parity.
- **Live database:** production has 43 applied migrations at exact remote-ledger tree `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c`, through `20260808041629_repair_momo_client_v3_displayed_asset_scope.sql` (`6cbf3f80d028d3fe54093b14bae59314913b4f0bfacfbf31fce4aa2a24e429ba`). Applied `01430` remains immutable at `987186e74590c6e484ebfee47e1c7ed384e2b4dc8c4a97ad7243ae38feb765cc`. The separate historical v36 repository/Sites-mirror fingerprint remains `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90`.
- **Corrective candidate:** the local candidate preserves immutable `01430` and mirrors the exact applied `041629` repair. It has 201 Sites files at `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292` and 43 mirrored migrations at `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c`. Its migration tree equals live production. PR #163 is open but not merged; exact-final-head workflows and review-thread evidence remain unrecorded, and corrected Sites v38 is unpublished.
- **Completed and next:** `01210`, immutable `01430`, Sites v37, `01842`, `01853`, `02609`, and verified `041629` are complete. No database migration remains pending. Production authority is granted, but automatic deployment is disabled: after exact candidate review and green gates, publish and verify corrected Sites v38. `02609` remains non-comprehensive because live `postgres` is not a `supabase_admin` member and that role was skipped.
- The private synthetic policy-evaluation evidence remains local-only. No provider connection, external publication authority, owner authority, or Momo activation is created by the rollout.
