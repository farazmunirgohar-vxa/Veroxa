...
- **Live Sites:** Sites v37 is live from checkout `61e9ace7723ef56f42111f320327187596406944`, with 200 files at `929e05cf68a6af5176811f49321ec108e617b93a08153b65b3f86b109d0c8c18`. Canonical GitHub `main` is `65dfe0e921c4bb1d66c273ec33f36d10bbf2e84d`; this is partial-rollout truth, not corrected-source parity.
- **Live database:** production has 42 applied migrations at exact remote-ledger tree `dc565dd1f5f4a5efe6a2b253e7437e93f6364b5581c56bb811969fa7241a7a84`, through `20260808002609_future_object_default_acl_hardening.sql` (`ab41ed8adf7170d81dc60a51607b12497cae6d52f1c28f63639e4fef6392e01a`). Applied `01430` is immutable at `987186e74590c6e484ebfee47e1c7ed384e2b4dc8c4a97ad7243ae38feb765cc`. The separate historical v36 repository/Sites-mirror fingerprint remains `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90`.
- **Corrective candidate:** the local candidate restores immutable `01430` and adds sole pending forward migration `20260808040400_momo_client_pipeline_displayed_rights_scope_fix.sql`. It has 201 Sites files at `a007f78d2826aa9b9f372f1aec8cae4d768e759ba15e6b7cf7281a013b79db3e` and 43 mirrored migrations at `3efcc5266275463665f45eed9320cd3bf108abe623c2a7771558789ecd1c669e`. Its pull request is null; the repair is unapplied and corrected Sites v38 is unpublished.
- **Completed and next:** `01210`, immutable `01430`, Sites v37, `01842`, `01853`, and `02609` are complete. Production authority is granted for the exact correction, but automatic deployment is disabled: after exact candidate review and green gates, apply and verify `040400`; only then publish and verify corrected Sites v38. `02609` remains non-comprehensive because live `postgres` is not a `supabase_admin` member and that role was skipped.
