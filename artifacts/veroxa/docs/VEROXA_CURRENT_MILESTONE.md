...
- **Reviewed build:** branch `agent/momo-readiness-closeout`, based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`, adds arbitrary-food-safe deterministic tags plus Team Ready approve/discard. Its pre-apply candidate is 203 Sites files at `fce38a41f6afc94d5999d3268baea3c72012a8205f1bf97008e3f04900db6b37` and 44 mirrored migrations at `7ea30e35ee2dd88fc936521d352ef1b5794b6bfea981afd7e1b9b5c8a22af16c`. No PR exists yet; nothing is merged, applied, or published.
- **Pending migration identity:** provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is mirrored at exact SHA-256 `3d6394b402247d599f80466855dc14326d48add91f359b70a5cd75a9058fd441`. Supabase MCP generates the applied ledger version. The exact bytes are the invariant; after apply, a terminal follow-up PR must rename both mirrors to the observed generated version and refresh evidence before Sites publication.
