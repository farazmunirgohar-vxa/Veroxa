...
- **Observed production:** canonical GitHub `main` is merged PR #163 at `59b1604d887547e2804bdd6d63c97292385dcebb`; Sites v39 is live from checkout `8749a7d442d3bb068ce626a9d297b8b227493446`, 201 files at `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292`. Production remains exact live43 at `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c` through verified `041629`; historical v36 repository/Sites-mirror tree `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90` is not the live ledger.
- **Reviewed build:** draft PR #164 is open from `agent/momo-generic-food-ready-review-v5`, based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`, and adds arbitrary-food-safe deterministic tags plus Team Ready approve/discard. Its observed opening head `b659ec307da9455c389059b29f2d6f3ab51f095e` / Git tree `9931d63dcb16a2e2e1cb7c592d2da63b4054cb60` is a draft observation, not final-head workflow/review evidence. The candidate remains 203 Sites files at `a8d5b75ab251f3502b87ec2c99c5f3d51aa7381e0ccefbc94b6183bb92a4c1d0` and 44 mirrored migrations at `9cc0bba007b6a0c06edf33563fb1bc3f4650811f8f8ea1639cc58c7028ac7324`; PR #164 is unmerged and nothing is applied or published.
- **Pending migration identity:** provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is mirrored at exact SHA-256 `9cf6f0080d38d58d3c1939d928444701b1954bf5cfe96bf7f3e80077bad45cc0`. Supabase MCP generates the applied ledger version. The exact bytes are the invariant; after apply, a terminal follow-up PR must rename both mirrors to the observed generated version and refresh evidence before Sites publication.
- **Next release gate:** create and green the feature PR, then enforce merge → freeze new reservation/auto-advance/dispatch ingress → drain all v4 nonterminal/webhook/outbox/unsettled-cost work to zero → apply exact SQL bytes → verify DB v5 plus v4 compatibility → merge generated-version reconciliation → publish and verify terminal Sites source → restore bounded internal ingress. Live Sites v39 is v4 while DB44 makes new reservations v5, so the freeze/drain gate is mandatory.
- **Safety boundary:** scoped production database/Sites permission exists, but automatic deployments remain disabled and every step is incomplete. `02609` remains non-comprehensive because live `postgres` is not a `supabase_admin` member. Providers, public writes, schedules, posts, review replies, website writes, owner authority, and Momo activation remain locked.
