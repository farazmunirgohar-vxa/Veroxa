...
| `demoClientTeamWork.ts` | `client_team_submissions`, `client_team_messages`, `client_action_items` | `demoClientTeamSubmissions`, `demoClientTeamMessages`, `demoClientActionItems`, `ClientTeamSubmission`, `ClientTeamMessage`, `ClientActionItem`, helpers (`getClientTeamSubmissions`, `getSubmissionsForClient`, `getOpenClientActions`, `getTeamInboxSubmissions`, `getBlockedSubmissions`, `getClientTeamMessages`, `getSubmissionMessages`, `getClientTeamWorkSummary`) |
