# Momo Brand Voice + AI Prompt Rules Pack

GitHub PR #117 adds Momo Brand Voice + AI Prompt Rules Pack only.
...
The Team-only `/team/momo-brand-ai-rules` route organizes brand voice foundation, approved tone, unsafe tone, content pillar prompt rules, caption drafting rules, local SEO rules, sensitive-claim rules, media dependency rules, business-truth dependency rules, AI forbidden outputs, prompt template boundaries, Team review requirements, future confirmation questions, and the safe internal next decision.

Content pillars include Momo Cravings, First-Time Education, Behind The Scenes, Customer / Reaction Content, Snack Discovery, Local SEO / Momo spot positioning, and Sauce / spice / pairing content.
