...
The reviewed local feature branch is `agent/momo-readiness-closeout`, based on exact main `59b1604d887547e2804bdd6d63c97292385dcebb`. Its pre-apply source identity is 203 Sites files at `fce38a41f6afc94d5999d3268baea3c72012a8205f1bf97008e3f04900db6b37` plus 44 mirrored migrations at `7ea30e35ee2dd88fc936521d352ef1b5794b6bfea981afd7e1b9b5c8a22af16c`. No feature PR exists yet. The candidate is not in GitHub main, not applied to the database, not published to Sites, and not activation evidence.

The sole pending source migration is provisional `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql`, mirrored byte-for-byte at SHA-256 `3d6394b402247d599f80466855dc14326d48add91f359b70a5cd75a9058fd441`. Supabase MCP generates the production ledger version and cannot promise `045812`. Apply only these exact reviewed bytes, capture the generated version, then immediately merge a terminal follow-up PR that renames both source mirrors to that version without changing SQL bytes and refreshes the live, candidate, and Sites fingerprints. Only the exact-byte payload—not the provisional filename—is stable across the apply boundary.
