...
- **Production now:** GitHub `main` is merged PR #163 at `59b1604d887547e2804bdd6d63c97292385dcebb`; Sites v39 is live from `8749a7d442d3bb068ce626a9d297b8b227493446`, 201 files at `4edae9660343cda362968bd08e544ba5a154c90a902ac961365ceb32ea820292`. Supabase remains exact live43 at `8a49f00ab3bd6d9623100fec238939b6cb81f17d67d0e2d3a4426559c137e41c` through verified `041629`. Historical repository/Sites-mirror evidence is `9f5d71e6487a00a9676d70dbc7022d383fd16e32f3f2a367c8d1ff7608031c90`.
- **Candidate evidence:** draft PR #164 is open from `agent/momo-generic-food-ready-review-v5`, base main59b, at observed opening head `b659ec307da9455c389059b29f2d6f3ab51f095e` / tree `9931d63dcb16a2e2e1cb7c592d2da63b4054cb60`. This is not exact-final-head workflow/review evidence. The locally reviewed candidate remains 203 Sites files at `a8d5b75ab251f3502b87ec2c99c5f3d51aa7381e0ccefbc94b6183bb92a4c1d0` and 44 mirrored migrations at `9cc0bba007b6a0c06edf33563fb1bc3f4650811f8f8ea1639cc58c7028ac7324`. TypeScript, lint, verified build, 410/410 application tests, 46 statements/19 migration PL/pgSQL bodies, 354/88 pgTAP parse at exact fixture SHA-256 `11740e1a55be4eef8a4fa25464959e7d28831841777974ca9e21fdd99a7e85c0`, and 89/89 focused contracts are green. PR #164 is unmerged; exact-final-head workflows and review threads remain unrecorded.
- **Pending database source:** `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is unapplied and mirrored at SHA-256 `9cf6f0080d38d58d3c1939d928444701b1954bf5cfe96bf7f3e80077bad45cc0`. `045812` is provisional source identity, because Supabase MCP generates the live ledger version. A post-apply follow-up PR must rename both mirrors to that observed version with unchanged bytes and refresh fingerprints.
- **Rollout status:** every new-release step is pending: feature PR merge → ingress freeze → v4 drain → exact-byte MCP apply → hosted DB/security verification → generated-version reconciliation PR → terminal Sites publish/verify → bounded ingress restore. Neither DB-first nor Sites-first is safe while live Sites v39 speaks v4 and DB44 makes new reservations v5.
- **Residual safety:** production database/Sites permission is scoped and explicit; automation remains disabled. Applied `02609` retains its non-comprehensive `supabase_admin` ACL residual. Provider connections, external/public writes, schedules, posts, review replies, website writes, and Momo activation remain false.
