...
- **Repository reconciliation:** canonical GitHub `main` remains `fb6d8b13bf548fd144cec4ce241bd44c1cecc99f` from PR #179. PR #181 operational head `b59ba5f1ef013aab2d36a3fd108a896b64e5bfd8` (tree `6246edeea1d1ec8dc8fd5880c4fc7867001fefb5`) passed CI #489 (run 31647260918), Sites Verify #179 (run 31647260962), Supabase Verify #149 (run 31647260942), and Veroxa Verify #434 (run 31647260978), with zero review threads. Evidence-head validation and merge remain pending, so canonical-main parity is not yet claimed.
