...
- **Production now:** Sites v37 is live from `61e9ace7723ef56f42111f320327187596406944` (200 files, `929e05cf68a6af5176811f49321ec108e617b93a08153b65b3f86b109d0c8c18`). The exact live database has 42 migrations at `dc565dd1f5f4a5efe6a2b253e7437e93f6364b5581c56bb811969fa7241a7a84`, through `20260808002609_future_object_default_acl_hardening.sql`. Canonical `main` is `65dfe0e921c4bb1d66c273ec33f36d10bbf2e84d`.
- **Applied-history boundary:** `20260808001430_momo_client_pipeline_readback_v3.sql` was applied at immutable SHA-256 `987186e74590c6e484ebfee47e1c7ed384e2b4dc8c4a97ad7243ae38feb765cc`. Source must restore those exact bytes; the displayed-rights change belongs only in forward migration `20260808040400_momo_client_pipeline_displayed_rights_scope_fix.sql`.
- **Candidate evidence:** branch `agent/momo-client-v3-forward-scope-repair` has 201 Sites files at `a007f78d2826aa9b9f372f1aec8cae4d768e759ba15e6b7cf7281a013b79db3e` and 43 mirrored migrations at `3efcc5266275463665f45eed9320cd3bf108abe623c2a7771558789ecd1c669e`. Corrective PR is null; local review has not yet been recorded; `040400` and corrected Sites v38 are not live.
- **Rollout status:** `01210`, immutable `01430`, Sites v37, `01842`, `01853`, and `02609` are complete. Production authority is granted for the exact repair-and-republish sequence, but automatic deployment is disabled: pass local and hosted gates, apply/verify `040400`, then publish/verify Sites v38.
