...
- **Dormant activation candidate:** the exact 216-file candidate source is `6aa459a7462f7b71cd55e8e15861bafff497b6c5a5ac4e6769a35e23fc016d51`; its 49-migration tree adds only mirrored `20260809044000_guarded_internal_ai_activation_v1.sql` (24,248 bytes, SHA-256 `22d5e82f683c3dd9d4b3d9c5b4e5003cf3a769f67dde340e98deee3ba3afb8ba`). Applying it only installs a postgres-only, no-grant routine bound to the verified first GitHub/Sites/Edge identities; it does not activate AI.
