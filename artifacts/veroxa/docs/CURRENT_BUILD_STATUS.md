...
- **Canonical repository:** GitHub `main` is `2721545d5823dbd4cbc233e7473d25393f4ff0ec` from merged PR #169. Its exact reviewed head `78c1f90d1412375b136aa18adcf9c4c1addc781e` and tree `37cbc6d7815dde6984b2691006ac3977df1a7226` passed CI `31296663350`, Sites `31296663318`, Supabase `31296663330`, and Veroxa `31296663326` with zero review threads.
...
- **Guarded activation:** the routine was invoked exactly once at `2026-08-09T05:35:42.103503Z`, bound to merged GitHub `2721545d`, Sites v41/source `766ba3bc`/`96ab0a58`/archive `74c287e6`, and JWT-protected Edge v7/bundle `a6b00fee`. Audit event `d31dc513-f953-4aca-9746-3f69447a6ae8` records those identities.
...
- **Postflight and cost:** relevant work and outbound HTTP remain zero; no provider call was observed; incremental spend is USD 0. A rollback-only authenticated-role smoke verified the authorized Team identity, target membership, read-only RPC access, and no direct candidate-table INSERT privilege. Prior live cross-tenant denial evidence remains authoritative because no second live restaurant existed for a fresh negative target.
- **Release closeout:** the scoped internal-AI rollout is complete. No further Sites or Edge deployment is required for this evidence-only closeout; GitHub/Sites/Edge/database identities remain exact.
