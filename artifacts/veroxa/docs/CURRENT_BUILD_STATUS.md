...
## 2026-08-09 — media upload one-step Team processor live; GitHub/Sites parity verified (current authority)
...
- **Durable intake and Team processing:** Supabase is live52 through generated `20260809232154_momo_media_instruction_team_processor_fix_v1.sql`, 9,601 canonical bytes at SHA-256 `455a75c64148cdcf7b77e0a7a4f177285d8b9143b15d6fff62a3a897b4924a3d`. Live51 revokes authenticated v2 registration and adds the immutable application ledger; live52 corrects its processor before use. New uploads save rights plus the Client instruction atomically through v3. The Team-only saved-instruction processor accepts only restaurant and asset IDs, reads the uploader's immutable evidence, and never creates owner truth. Zero instruction and application rows exist because no upload occurred after live50.
- **Live Sites:** Sites v45 is live at `veroxasystems.com` with version ID `appgprj_6a53d07c7c28819182801cf35dfd30de~appgver_8f22cdda7ebc8191a2275d0f60ad4a4f`, source commit `e6b73d285cbf6013d0c643f724e0f9a50ff14348`, 219-file live source SHA-256 `514e275d110d1c34dc71df235af3ebc679826b6f3c6306286b538cf23c66857e`, archive SHA-256 `5992c4a0764b930337c0bdc01c416dd708afb6e429e3da842c7488a702172803`, and environment revision 13. The live source is byte-matched to the canonical PR #174 media-handoff source, including generated live50-live52 names and the Team processor UI.
...
- **Canonical status:** GitHub's deployable application source is commit `13dab3f701aded8c5d62645203e875d43b983d8e` from merged PR #174. Exact reviewed head `a35c5e5900e02227a4c32c37df8387427a561676` at tree `c32a478134e711aae4a9051cea38231361fed72f` passed CI, Sites Verify, Supabase Verify, and Veroxa Verify with zero unresolved review threads. Merged evidence-only PR #175 records the parity without changing application, migration, database, Edge, environment, or runtime behavior. GitHub's deployable source, Sites v45, the 219-file source fingerprint, live50-live52, the authenticated-v2 revocation, and Team-only processing are in verified parity.
