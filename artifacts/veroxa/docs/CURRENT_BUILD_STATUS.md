...
## 2026-08-12 — Sites v53 and Supabase live56 reconciled (current authority)

- **Live portal:** `https://veroxasystems.com` serves Sites v53, version `appgprj_6a53d07c7c28819182801cf35dfd30de~appgver_6e36025a6f248191a047d9bbdd04d90a`, from Sites source `f21cd4e9b99d601d8e3df9b221e14b513a8ac2d6`. The 52-file release archive is 6,041,600 bytes at SHA-256 `99fd27fa4fa00f9c5522a74b0504d14fac1ccd26e9a685b343be4f6a34554c21`; environment revision 14 is active, and both apex and `www` domains have active SSL.
- **High-resolution intake:** the obsolete 16,777,216-total-pixel ceiling is removed across portal, API, and database. All PNG deflate streams are fully validated without allocating a decoded raster, and every high-resolution original must pass the trusted host decoder before processing. The 10 MB source limit, 12,000-pixel per-axis bounds, 0.4–2.5 intake aspect-ratio bounds, byte verification, tenant isolation, immutable evidence, and `external_write_allowed=false` remain enforced.
- **Live database:** Supabase is ACTIVE_HEALTHY at live56 through `20260812221509_restore_high_resolution_media_finalize_service_role_v1.sql` (652 bytes; SHA-256 `8a740ea365a462e9c9dea55f795f2025bfff7f9fe4db3bb25d2bfaab535988b3`). Canonical root and Sites mirrors contain 56 byte-identical migrations at tree SHA-256 `8d6f2b940bee42462c50349101af36f5efedb4f7d4309a18167261fbd342c8fe`. Live privilege verification is narrow: `anon=false`, `authenticated=false`, and `service_role=true` for the repaired finalizer.
...
- **Repository reconciliation:** canonical GitHub `main` remains `fb6d8b13bf548fd144cec4ce241bd44c1cecc99f` from PR #179. PR #181 operational head `51622596b20a0e0dc17ebe5e8332da8235722544` (tree `f9b89e77e8f13941e472606717fcc096766ba14a`) passed CI #496 (run 31649258356), Sites Verify #186 (run 31649258357), Supabase Verify #156 (run 31649258338), and Veroxa Verify #441 (run 31649258350), with zero review threads. Evidence-head validation and merge remain pending, so canonical-main parity is not yet claimed.
...
## 2026-08-12 — Momo live54 rights-attestation repair; Sites v50 deployed (historical authority, superseded by v53/live56)
