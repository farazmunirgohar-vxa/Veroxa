...
## 2026-08-09 — first parity verified; dormant activation migration under review (current authority)

- **Canonical repository:** GitHub `main` is `a1c6796b50a1072a96a40db283503d9e2c81bbae` from merged PR #167. Its exact reviewed head `ec7a312f59a7909203f309fa9bd5cf6c2512b125` passed CI `31294585263`, Sites `31294585255`, Supabase `31294585261`, and Veroxa `31294585259` with zero review threads.
- **Production database:** Supabase remains live48 through generated `20260809035302_team_private_food_assessment_reconciliation_v1.sql`, 59,052 canonical bytes at SHA-256 `56c64c795ad12f1dfbe05894fd3e56a87f1d0e3376ff10edfd97760b8d2fbd5c`; the 59,053-byte apply transport differed only by one trailing newline and the ledger stores the generated name, not query bytes.
- **First runtime parity:** Sites v40 is live at `veroxasystems.com` from source commit `4ee8895f68505e8ea79bf3e0f3ea3b2871ca2b2c` and reviewed source SHA-256 `cec2f313e3850141117c7f69dbc1d5ad707b72ee7a7ad5f1f2efa0d6c5a34297`. JWT-protected Edge v7 is ACTIVE with exact two-file source, bundle SHA-256 `a6b00feeab795faa91d6d8d015c4ad399c526e1b35f702778a8c55aaba49503d`, and unauthenticated POST 401.
- **Safety hold:** a fresh post-parity read proves 59/59 scoped public functions have zero effective anon/authenticated/service-role grants, one all-false runtime row, and zero assessment, AI, dispatch, webhook, Ready, or cost work. The registered mutable-RPC hold remains active. The Client storage residual may create only an unregistered orphan object.
- **Dormant activation candidate:** the exact 216-file candidate source is `e0e24212a0c7dd3026c0362109ab0faba62ba3b66df1ac31e3737f92d369126e`; its 49-migration tree adds only mirrored `20260809044000_guarded_internal_ai_activation_v1.sql` (24,248 bytes, SHA-256 `22d5e82f683c3dd9d4b3d9c5b4e5003cf3a769f67dde340e98deee3ba3afb8ba`). Applying it only installs a postgres-only, no-grant routine bound to the verified first GitHub/Sites/Edge identities; it does not activate AI.
- **Next governed sequence:** review and merge the dormant migration → apply under the hold → reconcile its generated version → publish second exact Sites/Edge parity → invoke once as postgres only after exact identity and zero-work gates → verify internal authority, budget, denials, and external locks.
