...
- Reviewed local candidate `agent/momo-readiness-closeout` is based on exact main59b and has 203 Sites files / `fce38a41f6afc94d5999d3268baea3c72012a8205f1bf97008e3f04900db6b37` plus 44 mirrored migrations / `7ea30e35ee2dd88fc936521d352ef1b5794b6bfea981afd7e1b9b5c8a22af16c`. No feature PR exists; GitHub merge/workflows/reviews, database apply, Sites publish, and activation are unclaimed.
- Pending source migration `20260808045812_momo_ready_team_decisions_and_food_tags_v2.sql` is mirrored at exact SHA-256 `3d6394b402247d599f80466855dc14326d48add91f359b70a5cd75a9058fd441`. Supabase MCP generates the live version. After exact-byte apply, the generated version must be verified and both mirrors renamed to it with unchanged bytes in a terminal follow-up PR before Sites publication.
