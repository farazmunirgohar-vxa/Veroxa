...
export const teamPortalNavItems: SidebarItem[] = [
  ...
  { label: "Momo Work", icon: ListChecks, href: "/team/momo/work" },
  { label: "Momo Intelligence", icon: SearchCheck, href: "/team/momo/intelligence" },
  { label: "Momo Content + AI", icon: BotMessageSquare, href: "/team/momo/content-ai" },
  { label: "Momo Reports", icon: ClipboardList, href: "/team/momo/reports" },
  { label: "Momo Readiness", icon: ShieldAlert, href: "/team/momo/readiness" },
