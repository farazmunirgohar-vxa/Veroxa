...
export default function TeamAiDrafts() {
  ...
  return (
    <PortalLayout items={teamPortalNavItems} portalName="Team Portal">
      ...
      <Button asChild className="mt-4" size="sm" variant="outline"><Link href="/team/momo-ai-approval">Review AI draft approval blockers</Link></Button><TeamReviewModeRouteSummary title="AI Draft Queue safe-draft summary" />
    </PortalLayout>
  );
}
