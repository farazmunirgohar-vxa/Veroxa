...
const PAST_UPDATES = [
  {
    ...
    summary:
      "Content and local visibility work moved forward. Monthly report notes were prepared for review.",
  ...
  },
  {
    ...
    summary:
      "Content preparation continued and the next media needs were shared.",
...
export default function ClientUpdates() {
  ...
  const weeklyUpdate = canUseFixtureData
    ? generateClientWeeklyUpdate(SHOWCASE_ID)
    : {
        weekLabel: "Weekly update in review",
        clientSafeSummary: "Live account updates are being prepared.",
        completedWork: ["Account setup is in review."],
        inProgressWork: ["Live update data is not connected yet."],
        needsClientInput: ["Veroxa will ask here if anything is needed."],
        nextWeekFocus: ["Prepare the first live account update."],
        headline: "Live account updates are being prepared",
        visibilityProgress: [
          "Local visibility progress will appear after setup.",
        ],
      };
    ...
    <PortalLayout items={clientPortalNavItems} portalName="Client Portal">
      ...
      <div className="mb-4">
        ...
        <p className="text-muted-foreground mt-1 text-sm md:text-base">
          What your Veroxa team has been working on — content, local visibility,
      ...
      >
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            {[
              ...weeklyUpdate.completedWork,
              ...weeklyUpdate.inProgressWork,
              ...weeklyUpdate.visibilityProgress,
            ]
              .slice(0, 6)
              .map((item, i) => (
                <div
          ...
          <p className="text-[11px] text-muted-foreground">
            Post thumbnails will appear here once your restaurant&apos;s media
            is connected.
          </p>
        </CardContent>
      </Card>
      ...
      {(() => {
        const actions =
          clientTeamWorkRepository.getClientActionRequiredItems(SHOWCASE_ID);
      ...
      {canUseFixtureData &&
        (() => {
          const inProgress =
            clientTeamWorkRepository.getClientInProgressItems(SHOWCASE_ID);
      ...
      {canUseFixtureData &&
        (() => {
          const updates = clientTeamWorkRepository.getClientLatestStatusUpdates(
            SHOWCASE_ID,
            5,
          );
                ...
                <CardContent className="p-4 space-y-2">
                  {updates.map((u) => (
                    ...
                    >
                      ...
                      <Badge
                        variant="outline"
                        className={`text-[9px] flex-shrink-0 ${labelTone[u.label]}`}
                      >
                        {u.label}
                      </Badge>
                    </div>
