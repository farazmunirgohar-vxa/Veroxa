import { Building2, Camera, CalendarDays, FileText, ArrowRight } from "lucide-react";
...
export default function ClientAccount() {
  ...
  return (
    <PortalLayout items={clientPortalNavItems} portalName="Client Portal">
      ...
      <DemoOnlyBanner message="Demo only — sample client view." testId="banner-client-account" />
      ...
      <Card className="bg-card border-border mb-4">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <Camera className="w-4 h-4 text-sky-400" /> Media guidance
          </CardTitle>
        </CardHeader>
        <CardContent>
          {runway ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        ...
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm flex items-center gap-2">
              <CalendarDays className="w-4 h-4 text-primary" /> Upcoming content
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm flex items-center gap-2">
              <FileText className="w-4 h-4 text-violet-400" /> Published reports
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            {reports.length === 0 ? (
      ...
      {/* What we need next — full width */}
      <Card className="bg-card border-primary/30">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <ArrowRight className="w-4 h-4 text-primary" /> What we need from you next
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-2">
          {requests.length === 0 ? (
