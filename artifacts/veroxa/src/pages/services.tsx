...
const serviceScope = [
  ...
  "Media guidance and monthly online presence reporting",
      ...
      <main className="pt-28 pb-20 px-6 lg:px-12 flex-1">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="rounded-2xl border border-border/40 bg-card/20 p-5 text-sm text-muted-foreground mb-8">
            Basic website alignment/refinement is included when access is provided. Full website development, customer-service replies, daily posting, TikTok/Reels/video support, ads management, paid ad spend, and guaranteed results are not included at launch.
          </div>
