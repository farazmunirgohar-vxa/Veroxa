...
import { Activity, Bot, FileText, KeyRound, Inbox, MessagesSquare, PackageCheck, Images, SearchCheck, BotMessageSquare, ShieldAlert, SlidersHorizontal, Sparkles, ShieldQuestion, ClipboardCheckIcon, Home } from "lucide-react";
...
export default function TeamControlCenter() {
  ...
  return <PortalLayout items={teamPortalNavItems} portalName="Team Portal"><div className="mb-4 flex items-start justify-between gap-3"><div><h2 className="text-2xl font-bold tracking-tight" data-testid="header-team-control-center">Internal Control Center</h2><p className="mt-1 text-sm text-muted-foreground">Team-only summary of existing internal queues. Nothing is published automatically.</p></div><Badge variant="outline">Team only</Badge></div><GuardrailCopy />
    <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-3"><SummaryCard title="Work needing review" value={summary.work_needing_review} icon={SlidersHorizontal} /><SummaryCard title="Client-visible risk / owner confirmation needed" value={summary.client_visible_risk_or_owner_confirmation} href="/team/profile-corrections" icon={ShieldAlert} /><SummaryCard title="AI drafts needing review" value={summary.ai_drafts_needing_review} href="/team/ai-drafts" icon={Bot} /><SummaryCard title="Messages needing reply" value={summary.messages_needing_reply} href="/team/messages" icon={MessagesSquare} /><SummaryCard title="Profile corrections pending" value={summary.profile_corrections_pending} href="/team/profile-corrections" icon={SlidersHorizontal} /><SummaryCard title="Media needing review" value={summary.media_needing_review} href="/team/upload-inbox" icon={Inbox} /><SummaryCard title="Recent activity" value={summary.recent_activity} href="/team/activity-log" icon={Activity} /><SummaryCard title="Reports From Activity foundation" value="PR #108" href="/team/reports-from-activity" icon={FileText} /><SummaryCard title="Momo Workspace" value="PR #126" href="/team/momo" icon={Home} /><SummaryCard title="Momo readiness gate" value="PR #109" href="/team/momo-live-readiness" icon={ShieldAlert} /><SummaryCard title="Momo Internal Prep" value="PR #114" href="/team/momo-pilot-prep" icon={PackageCheck} /><SummaryCard title="Momo Business Truth" value="PR #115" href="/team/momo-business-truth" icon={SearchCheck} /><SummaryCard title="Momo Media + Content" value="PR #116" href="/team/momo-media-content" icon={Images} /><SummaryCard title="Momo Brand AI Rules" value="PR #117" href="/team/momo-brand-ai-rules" icon={BotMessageSquare} /><SummaryCard title="Momo AI Generation" value="PR #118" href="/team/momo-ai-generation" icon={Sparkles} /><SummaryCard title="Momo AI Approval" value="PR #119" href="/team/momo-ai-approval" icon={ShieldQuestion} /><SummaryCard title="Momo Dry Run" value="PR #120" href="/team/momo-dry-run-go-no-go" icon={ClipboardCheckIcon} /><SummaryCard title="Activation Gate" value="PR #111" href="/team/momo-activation-gate" icon={KeyRound} /></section>
...
function GuardrailCopy() {
  return <Card className="mb-4 border-amber-500/30 bg-amber-500/10"><CardContent className="grid gap-1 p-4 text-sm text-amber-100"><p><ShieldAlert className="mr-2 inline h-4 w-4" />Client-visible actions still require review.</p><p>Business-truth changes still require owner confirmation.</p><p>Reports From Activity is active as PR #108 foundation.</p><p>Momo owner walkthrough remains blocked.</p><p>Momo Live Pilot Readiness Gate is internal-only and does not change activation state.</p><p>Controlled Momo Pilot Activation Gate is internal-only and requires a later Faraz decision.</p><p>Momo Internal Prep is internal prep only; no activation and owner walkthrough blocked.</p><p>Momo Business Truth is internal truth review only; no activation, no owner contact, and owner walkthrough blocked.</p><p>Momo Media + Content is internal media/content inventory only; no activation, no upload/publication, and owner walkthrough blocked.</p><p>Momo Brand AI Rules is internal brand/prompt rules only; no AI generation, no activation, no owner contact, and owner walkthrough blocked.</p><p>Momo AI Generation is PR #118 controlled foundation only; AI generation disabled by default, no publishing, no activation, no owner contact, and owner walkthrough blocked.</p><p>Momo AI Approval is PR #119 internal approval queue only; no AI generation, no auto-approval, no publishing, no activation, no owner contact, and owner walkthrough blocked.</p><p>Momo Dry Run is PR #120 internal dry run/go-no-go only; no activation, no owner contact, no client visibility, no fabricated reports or activity, and owner walkthrough blocked.</p><p>Momo Workspace is PR #126 consolidation only: Momo-only internal workspace that consolidates work, intelligence, content/AI, reports, and readiness. No activation. Owner walkthrough blocked.</p><p>Use Momo Workspace as the primary grouped Team Portal path.</p><p>Standalone Momo pages remain compatibility/detail routes.</p><p>No activation.</p></CardContent></Card>;
}
