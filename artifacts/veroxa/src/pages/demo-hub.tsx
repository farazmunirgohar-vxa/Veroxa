...
import { ArrowLeft, BarChart2, LayoutDashboard, Settings2, User, Users } from "lucide-react";
  ...
  const portals = [
    {
      ...
      icon: User,
      label: "Client Portal",
      description: "See your project status, invoices, and deliverables",
    ...
    },
    {
      ...
      icon: Users,
      label: "Team Portal",
      description: "Manage tasks, time, and internal workflows",
    ...
    },
    {
      ...
      description: "Run projects, assign work, and track delivery",
    ...
    },
    {
      ...
      icon: BarChart2,
      label: "Owner Portal",
      description: "High-level financials, pipeline, and growth metrics",
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-lg text-muted-foreground">Explore each role's experience within the operating system.</p>
        </div>
