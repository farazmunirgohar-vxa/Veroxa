...
const TeamControlCenter = lazy(() => import("@/pages/team-control-center"));
const TeamReportsFromActivity = lazy(() => import("@/pages/team-reports-from-activity"));
const TeamMomoLiveReadiness = lazy(() => import("@/pages/team-momo-live-readiness"));
const TeamMomoActivationGate = lazy(() => import("@/pages/team-momo-activation-gate"));
  ...
  return (
    <RouteBoundary>
      <Switch>
        ...
        <Route path="/team/control-center">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamControlCenter />
        ...
        <Route path="/team/reports-from-activity">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
        ...
        <Route path="/team/momo-live-readiness">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoLiveReadiness />
              </RealPortalDataBoundary>
            </InternalDemoGuard>
          )}
        </Route>
        <Route path="/team/momo-pilot-prep">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoPilotPrep />
        ...
        <Route path="/team/momo-business-truth">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoBusinessTruth />
              </RealPortalDataBoundary>
            </InternalDemoGuard>
          )}
        </Route>
        <Route path="/team/momo-media-content">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
        ...
        <Route path="/team/momo-ai-generation">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoAiGeneration />
              </RealPortalDataBoundary>
            </InternalDemoGuard>
          )}
        </Route>
        <Route path="/team/momo-ai-approval">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoAiApproval />
        ...
        <Route path="/team/momo-dry-run-go-no-go">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoDryRunGoNoGo />
              </RealPortalDataBoundary>
            </InternalDemoGuard>
          )}
        </Route>
        <Route path="/team/momo-activation-gate">
          {() => (
            <InternalDemoGuard role="team">
              <RealPortalDataBoundary portal="team">
                <TeamMomoActivationGate />
              </RealPortalDataBoundary>
            </InternalDemoGuard>
          )}
        </Route>
