...
export function buildValueProofSummary(
  ...
  return {
    ...
    clientSafeSummary:
      "Customer-action signals are developing. Calls, directions, and menu clicks will become stronger proof signals when connected.",
    teamSummary:
      "Team-only preview separates reach from customer actions and keeps cost-justification review internal.",
    nextAction:
