...
const checks: Array<[ClientRequestType, RegExp]> = [
  ...
  ["full_website_redesign", /\b(full website redesign|redesign our website|new website design)\b/i],
  ["custom_website_build", /\b(custom website|build (a )?website|new website build|website from scratch)\b/i],
