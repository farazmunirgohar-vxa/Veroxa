...
export const demoMediaItems: DemoMediaItem[] = [
  ...
  { id: "mi4",  clientId: "demo-a", type: "Photo", title: "Lamb kebab close-up",            status: "Pending Review", qualityNote: "Pending Veroxa team review",             suggestedUse: "Maybe Friday feature",                                                dateAdded: "May 23" },
