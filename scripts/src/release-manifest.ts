...
function assertPrivateMediaR2VaultCandidateManifest(
  ...
  if (
    ...
    production.canonicalGitHubMainCommitScope !==
      "host-inspection diagnostics merged in GitHub main but not deployed; independent R2 media vault remains an unreleased candidate" ||
    production.githubParityVerifiedAtObservation !== false ||
  ...
  if (
    candidate.basedOnGitHubMainCommit !==
      "77dadd67505642353b431db3802d2ec365966869" ||
    candidate.pullRequest !== 187 || candidate.githubMerged !== false ||
  ...
  if (
    !quality || quality.testsPassed !== 487 || quality.testsTotal !== 487 ||
  ...
  ) failures.push("schema-14 local 487-test quality evidence drifted");
